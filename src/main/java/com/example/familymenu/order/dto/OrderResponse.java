...
public class OrderResponse {
    ...
    public OrderResponse(Long id, Long creatorUserId, String customerName, List<OrderItemResponse> items, String remark,
    ...
    public static OrderResponse from(Order order) {
        ...
        return new OrderResponse(order.getId(), order.getCreatorUserId(), order.getCustomerName(), items, order.getRemark(),
                order.getCreatedAt());
    }
